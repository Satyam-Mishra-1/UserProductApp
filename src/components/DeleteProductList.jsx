...
const styles = {
  ...
  heading: {
    ...
    letterSpacing: "2px",
    color: "#61dafb", // Change heading color to match App-link color
  },
  form: {
    display: "flex",
  ...
  button: {
    padding: "12px",
    fontSize: "1rem",
    backgroundColor: "#61dafb", // Change button color to match App-link color
    color: "#fff",
    border: "none",
    borderRadius: "4px",
    cursor: "pointer",
...
// Add hover effect
styles.button[':hover'] = {
  backgroundColor: "#0078d4", // Darker color on hover
};
